// cutnpaste from https://github/aspnet/mvc Microsoft.AspNetCore.Mvc.Infrastructure.DefaultActionDescriptorCollectionProvider
...
namespace Component.As.Service.Specs.FinerGrainedActionSelection.Tests.Microsoft.AspNetCore.Mvc.Infrastructure
{
    public class DefaultActionDescriptorCollectionProvider : ActionDescriptorCollectionProvider
    {
        ...
        public DefaultActionDescriptorCollectionProvider(
            ...
            IEnumerable<IActionDescriptorChangeProvider> actionDescriptorChangeProviders) : base(actionDescriptorProviders,actionDescriptorChangeProviders)
        {
        ...
        /// </summary>
        public new ActionDescriptorCollection ActionDescriptors
        {
            get
            {
                Initialize();
